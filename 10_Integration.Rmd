...
head(celltype_pred, 5)
Atac <- AddMetaData(Atac, metadata = celltype_pred)


AtacFiltered <- subset(Atac, subset = prediction.score.max > 0.5)
hist(Atac$prediction.score.max)
abline(v = 0.5, col = "red")

DimPlot(AtacFiltered, group.by = "predicted.id", label = TRUE, repel = TRUE) 
...
https://satijalab.org/seurat/archive/v3.1/atacseq_integration_vignette.html
